...
} from '../src/modules/drones/repositories/in-memory-drone-repository'
import {
  InMemoryMedicamentRepository
} from '../src/modules/medicaments/repositories/in-memory-medicament.repository'
import {
  MedicamentRepository
} from '../src/modules/medicaments/repositories/medicament.repository'
